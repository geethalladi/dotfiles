...
(defun self/prune-hibernate-logs ()
  "Cleanup unwanted logs generated by hibernate. Improves readability"
  (read-only-mode 'toggle)
  (flush-lines "JdbcTypeRegistry -" nil nil t)
  (flush-lines "Registering IdentifierGenerator" nil nil t)
  (flush-lines "HQL_FUNCTIONS " nil nil t)
  (flush-lines "Registered SqmFunctionTemplate" nil nil t)
  (flush-lines "Registering alternate key" nil nil t)
  (flush-lines "jar" nil nil t)
  (flush-lines "Adding type registration" nil nil t)
  (read-only-mode 'toggle))

(defun self/prune-spring-logs ()
  "Cleanup unwanted logs generated by Spring. Improves readability"
  (read-only-mode 'toggle)
  (flush-lines "o.s.b.f.s.DefaultListableBeanFactory" nil nil t)
  (read-only-mode 'toggle))
...
(defun self/prune-spring-logs ()
  ...
  (read-only-mode 'toggle)
  (flush-lines "o.s.b.f.s.DefaultListableBeanFactory" nil nil t)
  (flush-lines "o.h.type.BasicTypeRegistry - Adding type registration" nil nil t)
  (read-only-mode 'toggle))

(defun self/cleanup-logs ()
  (self/prune-hibernate-logs)
  (self/prune-spring-logs))
